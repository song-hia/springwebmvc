...
public class BoardVO {
	...
	public BoardVO(int idx, String title, String content, int readcount, int groupid, int depth, int reOrder,
			int isdel, String writeId, String writeName, Date writeDay) {
